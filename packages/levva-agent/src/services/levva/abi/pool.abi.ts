export default [
  ...
  { inputs: [], name: "BadLeverage", type: "error" },
  ...
  { inputs: [], name: "LessThanMinimalAmount", type: "error" },
  { inputs: [], name: "Locked", type: "error" },
  { inputs: [], name: "LongEmergency", type: "error" },
  { inputs: [], name: "NotEmergency", type: "error" },
  { inputs: [], name: "NotLiquidatable", type: "error" },
  { inputs: [], name: "NotWETH9", type: "error" },
  { inputs: [], name: "PositionInitialized", type: "error" },
  {
    inputs: [{ internalType: "address", name: "token", type: "address" }],
    name: "SafeERC20FailedOperation",
    type: "error",
  },
  { inputs: [], name: "ShortEmergency", type: "error" },
  { inputs: [], name: "ShortUnavailable", type: "error" },
  { inputs: [], name: "SlippageLimit", type: "error" },
  { inputs: [], name: "UninitializedPosition", type: "error" },
  { inputs: [], name: "WrongIndex", type: "error" },
  { inputs: [], name: "WrongPositionType", type: "error" },
  { inputs: [], name: "WrongValue", type: "error" },
  { inputs: [], name: "ZeroAmount", type: "error" },
  { anonymous: false, inputs: [], name: "BalanceSync", type: "event" },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: "address", name: "user", type: "address" },
      {
        ...
        name: "realBaseDebtDelta",
        type: "uint256",
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "discountedBaseDebtDelta",
        type: "uint256",
      },
    ],
    name: "BaseDebtRepaid",
  ...
  { anonymous: false, inputs: [], name: "ParametersChanged", type: "event" },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: "address", name: "user", type: "address" },
      {
        indexed: false,
        internalType: "uint256",
        name: "realQuoteDebtDelta",
        type: "uint256",
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "discountedQuoteDebtDelta",
        type: "uint256",
      },
    ],
    name: "QuoteDebtRepaid",
    type: "event",
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "baseDebtDistributed",
        type: "uint256",
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "quoteDebtDistributed",
        type: "uint256",
      },
    ],
    name: "Reinit",
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "discountedBaseCollateralDelta",
        type: "uint256",
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "discountedQuoteCollateralDelta",
        type: "uint256",
      },
    ],
    name: "SellBaseForQuote",
    type: "event",
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    outputs: [{ internalType: "uint256", name: "inner", type: "uint256" }],
  ...
  {
    inputs: [
      { internalType: "enum CallType", name: "call", type: "uint8" },
      { internalType: "uint256", name: "amount1", type: "uint256" },
      { internalType: "int256", name: "amount2", type: "int256" },
      { internalType: "uint256", name: "limitPriceX96", type: "uint256" },
      { internalType: "bool", name: "flag", type: "bool" },
      { internalType: "address", name: "positionAddress", type: "address" },
      { internalType: "uint256", name: "swapCalldata", type: "uint256" },
    ],
    name: "execute",
    outputs: [],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bool", name: "_short", type: "bool" },
    ],
    ...
    outputs: [
      ...
      {
        components: [
          { internalType: "uint96", name: "key", type: "uint96" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint32", name: "_defaultSwapCallData", type: "uint32" },
      {
        components: [
          { internalType: "uint8", name: "maxLeverage", type: "uint8" },
          { internalType: "uint24", name: "interestRate", type: "uint24" },
  ...
  },
  {
    inputs: [],
    name: "mode",
    outputs: [{ internalType: "enum Mode", name: "", type: "uint8" }],
    stateMutability: "view",
    type: "function",
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint24", name: "swapFee", type: "uint24" },
      { internalType: "uint24", name: "mcSlippage", type: "uint24" },
      { internalType: "uint184", name: "positionMinAmount", type: "uint184" },
      { internalType: "uint184", name: "quoteLimit", type: "uint184" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    ...
    name: "positions",
    outputs: [
      { internalType: "enum PositionType", name: "_type", type: "uint8" },
      { internalType: "uint32", name: "heapPosition", type: "uint32" },
      {
        internalType: "uint256",
