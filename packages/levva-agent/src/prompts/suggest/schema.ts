    ...
    .array(
      z.object({
        label: z
          .string()
          .describe(
            "Short, specific label for the button/chip UI element (2-10 words). Must clearly indicate what the suggestion does. Examples: 'Withdraw 100 USDC' (NOT 'Edit amount'), '50% of balance' (NOT 'Partial'), 'Safe yield strategy' (NOT 'Different strategy'), 'Cancel withdrawal'"
          ),
        text: z
          .string()
          .describe(
