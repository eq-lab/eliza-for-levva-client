export default [
  ...
  { inputs: [], name: "FutureFinalization", type: "error" },
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "owner", type: "address" },
      { internalType: "address", name: "levvaVault", type: "address" },
  ...
  {
    inputs: [{ internalType: "address", name: "finalizer", type: "address" }],
    name: "isFinalizer",
    outputs: [{ internalType: "bool", name: "", type: "bool" }],
    stateMutability: "view",
    type: "function",
